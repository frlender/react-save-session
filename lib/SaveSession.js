...
exports.defaultSessFormat = exports.ListSessions = exports.SaveSession = void 0;
...
function SaveSession(props) {
    ...
    var editTextWidth = props.editTextWidth ? props.editTextWidth : 80;
    ...
    return (0, jsx_runtime_1.jsxs)("span", __assign({ className: "rss-save-session" }, { children: [download && (0, jsx_runtime_1.jsx)("button", __assign({ onClick: function () { return download(); } }, { children: "Download" })), (0, jsx_runtime_1.jsx)("button", __assign({ onClick: function () { return save(); } }, { children: "Save" })), (0, jsx_runtime_1.jsx)(react_edit_text_1.EditText, { style: { width: "".concat(editTextWidth, "px") }, defaultValue: sessName, inline: true, onSave: function (e) { return setSessName(e.value); } })] }));
}
...
function defaultSessFormat(sessions, remove, enter) {
    return sessions.map(function (x) { return (0, jsx_runtime_1.jsxs)("div", __assign({ className: "rss-list-sessions-item" }, { children: [(0, jsx_runtime_1.jsx)("span", { children: (0, jsx_runtime_1.jsxs)("a", __assign({ onClick: function (e) { return enter(x); } }, { children: [x.sessName, " \u00A0 ", get_date_string(x.time)] })) }), "\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0", (0, jsx_runtime_1.jsx)("span", { children: (0, jsx_runtime_1.jsx)("a", __assign({ onClick: function (e) { return remove(x.uid); } }, { children: "remove" })) })] }), x.uid); });
}
exports.defaultSessFormat = defaultSessFormat;
